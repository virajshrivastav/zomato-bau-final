...
interface ZomatoLogoProps extends React.HTMLAttributes<HTMLDivElement> {
  /**
   * Size variant for the logo
   * - sm: 80px width (mobile, compact spaces)
   * - md: 120px width (default, headers)
   * - lg: 160px width (hero sections)
   * - xl: 200px width (landing pages)
   */
  size?: "sm" | "md" | "lg" | "xl";
  /**
   * Color variant
   * - red: Zomato brand red #E23744 (default)
   * - white: White for dark backgrounds
   * - black: Black for special cases
   */
 ...
 *
 * Displays the official Zomato logo with proper sizing and color variants.
 * Follows Zomato brand guidelines for logo usage.
 *
 * @example
 * ```tsx
 ...
 * <ZomatomLogo size="lg" color="white" />
 *
 * // Small logo with custom className
 * <ZomatomLogo size="sm" className="my-4" />
 * ```
 */
export const ZomatomLogo = React.forwardRef<HTMLDivElement, ZomatoLogoProps>(
...
ZomatomLogo.displayName = "ZomatomLogo";
